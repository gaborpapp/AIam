...
class Vector2dTest(unittest.TestCase):
    ...
    def test_inplace_add(self):
        v = Vector2d(2, 3)
        v += Vector2d(10, 20)
        self.assertEqual(Vector2d(12, 23), v)

    def test_add(self):
        v1 = Vector2d(2, 3)
        v2 = Vector2d(10, 20)
        self.assertEqual(Vector2d(12, 23), v1 + v2)
    ...
    def test_set_x(self):
        v = Vector2d(2, 3)
        v.x = 5
        self.assertEqual(Vector2d(5, 3), v)

    def test_equals_none(self):
        self.assertEqual(False, Vector2d(0,0) == None)
    ...
    def test_inplace_mul(self):
        v = Vector2d(2, 3)
        v *= 10
        self.assertEqual(Vector2d(20, 30), v)
