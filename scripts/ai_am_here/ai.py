...
command = "python2.7 applications/learn_recall_improvise.py --output-receiver-host=%s --pn-host=%s --with-ui --model=autoencoder --pn-convert-to-z-up --max-angular-step=0.15 --auto-friction --novelty=0.2 --extension=0.5" % (
