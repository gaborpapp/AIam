...
command = "python2.7 applications/learn_recall_improvise.py --output-receiver-host=%s --pn-host=%s --with-ui --model=autoencoder --pn-convert-to-z-up --learning-rate=0.0012 --max-angular-step=0.15 --auto-friction --novelty=0.2 --extension=0.5 --velocity=0.5 --factor=1 --preset=alien_egg" % (
